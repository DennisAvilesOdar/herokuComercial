        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Mantenimiento de contactos</h1>
                </section>
			...
			<div class="modal fade" id="myModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
				...
				<h4 class="modal-title" id="titulomodal">Título de la ventana</h4>
				  ...
				  <p>Dni Contacto <font color = "red">*</font>
				  	<input type="text" name="txtdni" id="txtdni" class="form-control input-sm" placeholder="" required=""><p>
				  <p>Apellidos <font color = "red">*</font>
				  	<input type="text" name="txtapellido" id="txtapellido" class="form-control input-sm" placeholder="" required=""><p>
				  	...
				  	<input type="email" name="txtemail" id="txtemail" class="form-control input-sm" placeholder="" required=""><p>
				  <p>
		    ...
		    <!-- FIN del formulario modal -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar nuevo contacto</button>
                        </div>
                    </div>
                    <p>

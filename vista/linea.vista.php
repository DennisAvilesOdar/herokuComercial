        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Mantenimiento de Lineas</h1>
                </section>
			...
			<div class="modal fade" id="myModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
				...
				<h4 class="modal-title" id="titulomodal">Título de la ventana</h4>
				  ...
				  <div class="row">
				    <div class="col-xs-3">
					<p>Código Linea<input type="text" name="txtcodigo" id="txtcodigo" class="form-control input-sm text-center text-bold" placeholder="" readonly=""></p>
				    </div>
				  </div>
		    ...
		    <!-- FIN del formulario modal -->
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar nueva linea</button>
                        </div>
                    </div>
                    <p>
...
<!--	<script src="js/cargar-combos.js" type="text/javascript"></script>-->
        <script src="js/linea.js" type="text/javascript"></script>
